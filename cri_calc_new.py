...
def calculate_cri(own, target, ves_dcpa, ves_tcpa, hr, rel_movement_angle, dist_euclid, speed_r, weights=[0.518738361, 0.262802607, 0.153747672, 0.064711359], eps=EPS):
    ...
    return np.dot(weights, [U_dcpa, U_tcpa, U_course, U_speed])
